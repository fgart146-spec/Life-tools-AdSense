...
| 생성 페이지 | 128개 (전부 정적 생성) |
| 단위 테스트 | 275개 |
| 내부 링크 | 2,514건 · 깨진 링크 0 |
...
- [x] 전기요금·4대보험·최저임금 기준값 검증 완료 (2026-08-25 · `docs/PHASE-LOG.md` 참고)
- [x] Supabase 프로젝트 생성 → 마이그레이션 적용 → 관리자 계정 등록 (2026-08-25 확인)
- [ ] GA4 측정 ID, Search Console 소유확인 값 입력
- [ ] `npm run verify` 통과 확인
- [ ] AdSense 신청 → 승인 후 게시자·슬롯 ID 입력
